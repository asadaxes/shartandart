...
@section('body')
    <nav aria-label="breadcrumb" class="breadcrumb-nav border-0 mb-2 mt-5">
        ...
        <div class="container">
            <div class="top-bar w-full h-auto flex justify-between items-center bg-white py-4 px-8 rounded-full drop-shadow-md">
                            ...
                            <form action="{{ route('cart.add') }}" method="post">
                                ...
                                <div class="buy-section">
                                    <div class="w-md-50 mt-5 flex gap-5 sm:w-1/2">
                                        ...
                                        <button {{ $cartproduct != null ? 'disabled' : ' ' }} class="w-full py-3 flex items-center justify-center gap-3 rounded-md border border-gray-300 opacity-60"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        @foreach ($relatedproducts as $key => $relatedproduct)
                            <div class="row no-gutters {{ $key == 0 ? '' : 'border-top'}}">
                                <div class="col-md-4">
