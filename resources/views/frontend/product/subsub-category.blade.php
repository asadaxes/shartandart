        ...
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page"><a
                            href="{{route('product.category', $subsubcategory->category->id)}}"> {{ $subsubcategory->category->name }}</a>
                </li>
                <li class="breadcrumb-item active" aria-current="page"><a
                            href="{{route('sub.category.product', $subsubcategory->subcategory->id)}}">{{ $subsubcategory->subcategory->name }}</a>
                </li>
    ...
    <script>
        $(document).ready(function () {
            ...
            function filterProducts() {
                ...
                var subsubcategoryId = $('.layoutcategory.active').data('id');
                var brands = [];
                ...
                $.ajax({
                    url: "{{ route('product.subsub.filter') }}",
                    type: 'POST',
                    data: {
                        min_price: minPrice,
                        max_price: maxPrice,
