                    ...
                    <div class="card card-primary">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control summernote" name="content" id="content" placeholder="Enter content">{{ $blog->content }}</textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="expire_date" name="expire_date" value="{{ $blog->expire_date }}">
                            </div>
