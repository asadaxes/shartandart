                        ...
                        <div class="card card-primary">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                  ...
                                  @if($product->subcategory && $product->subcategory->id != null)
                                ...
                                <div class="form-group">
                                  ...
                                  @if($product->subsubcategory && $product->subsubcategory->id != null)
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="key_features" id="key_features" value="{{ $product->key_features }}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="topbar_heading" id="topbar_heading" value="{{ $product->topbar_heading }}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="summernote" id="summernote" name="bottom_description">{{ $product->bottom_description }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label>Image</label>
                                    <small>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file" name="image_2" class="custom-file-input" id="product_img">
                                            <label class="custom-file-label" for="product_img">Choose file</label>
                                        </div>
                                    </div>
                                    @if($product->image_2)
                                        <div>
                                            <img src="{{ asset($product->image_2) }}" alt="" style="width: 100px; height: 100px;">
                                        </div>
                                    @endif
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file" name="image_3" class="custom-file-input" id="product_img">
                                            <label class="custom-file-label" for="product_img">Choose file</label>
                                        </div>
                                    </div>
                                    @if($product->image_3)
                                        <div>
                                            <img src="{{ asset($product->image_3) }}" alt="" style="width: 100px; height: 100px;">
                                        </div>
                                    @endif
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file" name="image_4" class="custom-file-input" id="product_img">
                                            <label class="custom-file-label" for="product_img">Choose file</label>
                                        </div>
                                    </div>
                                    @if($product->image_4)
                                        <div>
                                            <img src="{{ asset($product->image_4) }}" alt="" style="width: 100px; height: 100px;">
                                        </div>
                                    @endif
                                </div>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="card card-primary">
                            <div class="card-body">
                                ...
                                <div class="col-12">
                                  <label for="name">Select Atribute & Atribute Value</label>
                                  <small>
                                    ...
                                    <div class="row rowatribute" style="position: relative">
                                        @if($product->productatributes->count() > 0)
                                                    ...
                                                    <div class="form-group">
                                                        <select class="form-control select2 attribute_id" name="attribute_id[]" style="width: 100%;">
                                                            ...
                                                            @foreach ($attributes as $attribute)
                                                                <option value="{{ $attribute->id }}" {{ $attribute->id == $productatribute->atribute_id ? 'selected' : ' ' }}>{{ $attribute->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="form-group removeAttributeValue" id="removeAttr_{{ $attribute->id }}">
                                                        <select class="form-control select2 attributevalue" name="attributevalue[]" style="width: 100%;">
                                                            <option value="{{ $productatribute->atributevalue_id }}">{{ $productatribute->atributevalue->value }}</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            @endforeach
                                ...
                                <div class="col-12">
                                    <label for="name">Specification & Specification Description</label>
                                    <small>
                                    ...
                                    <div class="row rowspecification" style="position: relative">
                                        @if($product->specifications->count() > 0)
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <input type="text" class="form-control" name="specification[]" id="specification" value="{{ $specification->specification }}">
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <textarea class="form-control" name="specification_description[]">{!! $specification->specification_description !!}</textarea>
                                                </div>
                                            </div>
                                            @endforeach
                                        @else
